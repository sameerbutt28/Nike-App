...
<p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:maz-w-sm ">
  Get your shoes ready for the new term at your nearest Nike store. Find your perfect size in store. Get rewards.
</p>
...
<div className="flex flex-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
